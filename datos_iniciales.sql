...
('VENTAS',     'ingresos_mes_abril',     125000000, '2026-04-30', 'SANTIAGO'),
('VENTAS',     'ingresos_mes_abril',      87500000, '2026-04-30', 'VALPARAISO'),
('VENTAS',     'ingresos_mes_abril',      63000000, '2026-04-30', 'CONCEPCION'),
('ECOMMERCE',  'ventas_online_abril',     42000000, '2026-04-30', 'SANTIAGO'),
('ECOMMERCE',  'ventas_online_abril',     18500000, '2026-04-30', 'VALPARAISO'),
('INVENTARIO', 'stock_electronica',           4250, '2026-04-30', 'SANTIAGO'),
('INVENTARIO', 'stock_electronica',           2100, '2026-04-30', 'VALPARAISO'),
('INVENTARIO', 'stock_hogar',                 8700, '2026-04-30', 'SANTIAGO'),
('INVENTARIO', 'stock_hogar',                 5300, '2026-04-30', 'CONCEPCION'),
('FINANZAS',   'costo_operacional_abril', 38000000, '2026-04-30', 'SANTIAGO'),
('FINANZAS',   'costo_operacional_abril', 24000000, '2026-04-30', 'VALPARAISO'),
('FINANZAS',   'utilidad_bruta_abril',    87000000, '2026-04-30', 'SANTIAGO'),
('VENTAS',     'ingresos_mes_marzo',     118000000, '2026-03-31', 'SANTIAGO'),
('VENTAS',     'ingresos_mes_marzo',      81000000, '2026-03-31', 'VALPARAISO');
...
('Reporte de Ventas Abril 2026 — Santiago',
 'VENTAS',
...
('Reporte Financiero Q1 2026',
 'FINANCIERO',
 'Análisis financiero del primer trimestre 2026. Utilidad bruta consolidada: $87.000.000 CLP. Margen operacional promedio: 38,2%.',
 '2026-03-31', NULL),

('Reporte de Ventas Online Abril 2026',
 'VENTAS',
...
('Reporte KPIs Estratégicos — Abril 2026',
 'FINANCIERO',
